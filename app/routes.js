...
router.post('/opt-out/v1/details/4_do-you-know-your-NHS-number', function (req, res) {
  ...
  if (answer === 'yes') {
    ...
    res.redirect('/opt-out/v1/errors/validation/do-you-know-your-nhs-number/no-option-selected#error')
  }
});
...
router.post('/opt-out/v1/OTP/7_get-your-security-code', function (req, res) {
  ...
  if (answer === 'email') { // the || means this OR that
    ...
    res.redirect('/opt-out/v1/errors/validation/get-your-security-code/no-option-selected#error')
  }
});
